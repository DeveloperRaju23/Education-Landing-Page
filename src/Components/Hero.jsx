...
import image2 from "../../public/Group 512924.png"
...
const Hero = () => {
 ...
 <div className="bg-cover bg-center " style={{ backgroundImage: `url(${backgroundImage})` }}>
        <div className='container'>
            ...
            <h2 className='text-[30px] md:text-[45px] lg:text-[90px] font-bold text-[#0C0531] lg:leading-[90px] md:leading-[50px] tracking-wide'>Start <span className='text-[#61bd81]'>learning</span> skill From your favorite mentor</h2>
